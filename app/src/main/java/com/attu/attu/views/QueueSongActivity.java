...
public class QueueSongActivity extends Activity implements Observer, Runnable {
    private QueueSongThread upThread;
           ...
           // row.addView(t2);
            ...
            row.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    ...
                    Track toQueue = (Track) v.getTag();
                    APIUser apiUser = State.getState().getUser();
                    ...
                    trackUris.add(toQueue.uri);
                    trackNames.add(toQueue.name);
